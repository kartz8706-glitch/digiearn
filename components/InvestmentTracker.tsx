...
import { formatUgx, type Investment } from "@/lib/investmentStore";
...
export default function InvestmentTracker({ investments }: { investments: Investment[] }) {
  return (
              ...
              <div key={investment.id} className="grid gap-5 p-5 md:grid-cols-[1.4fr_1fr_1fr] md:items-center">
                <div className="flex items-start gap-3">
                  <div className="rounded-xl bg-[#43e58c]/10 p-3 text-[#43e58c]">
                    {unlocked ? <WalletCards size={19} /> : <LockKeyhole size={19} />}
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm"><InvestmentCountdown unlocksAt={investment.unlocksAt} /></p>
                </div>
